...
class TreatmentListTab extends Component {
  productColumns = ["Treatment ID", "Description"];
  ...
  onCreateNewClick = () => {
    this.props.history.push("treatmentlist/new");
  };

  onEdit = row => {
    this.props.history.push(`treatmentlist/edit/${row.id}`);
  };
...
const component = withStyles(styles, { withTheme: true })(TreatmentListTab);
