...
const Routes = () => (
  <Switch style={{ overflow: "auto" }}>
    ...
    />
    {/* patientlist */}
    <Route exact path="/patientlist" component={patientlist.patientlist} />
    <Route exact path="/patientlist/new" component={patientlist.AddNew} />
    <Route exact path="/patientlist/edit/:id" component={patientlist.AddNew} />
