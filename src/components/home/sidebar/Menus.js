    ...
    return (
      <Fragment>
        <List>
          ...
          <SidebarMenu
            isSelected={this.isSelected("patientlist")}
            onClick={() => this.onMenuClick("/patientlist")}
            text="Patients"
            icon={<GroupAdd />}
          />
          ...
          />
          <SidebarMenu
            isSelected={this.isSelected("mpatienttreatments") || this.isSelected("mtreatments")}
            onClick={() => this.onMenuClick("/mpatienttreatments")}
